...
config :firehose_simulator, FirehoseSimulatorWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "z7rsbJmkyvb78au+8QVQnHMKFKLnFF5CoOGOfW4iLnNK/2XCe9D7NEqCN/kNqFf7",
  watchers: [
...
config :firehose_simulator, FirehoseSimulatorWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/firehose_simulator_web/router\.ex$"E,
      ~r"lib/firehose_simulator_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :firehose_simulator, dev_routes: true
