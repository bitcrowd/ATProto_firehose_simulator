...
As described here: https://github.com/bluesky-social/atproto/blob/main/README.md#developer-quickstart

You can run `make run-dev-env-logged` for logs.
...
Go to `http://localhost:4000` to set DID.
