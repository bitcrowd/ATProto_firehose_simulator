defmodule FirehoseSimulator.Player.Scheduler.Supervisor do
  ...
  Started dynamically by `FirehoseSimulator.Player.start/1` and stopped by
  `FirehoseSimulator.Player.stop/1`.
  ...
  def init(opts) do
    ...
    worker_batch_size = Keyword.get(opts, :worker_batch_size, worker_max_concurrency * 4)
