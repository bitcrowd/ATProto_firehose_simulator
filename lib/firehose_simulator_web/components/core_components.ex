defmodule FirehoseSimulatorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(FirehoseSimulatorWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(FirehoseSimulatorWeb.Gettext, "errors", msg, opts)
    # end
